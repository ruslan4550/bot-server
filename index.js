...
const i18n = {
    ...
    tr: {
        ...
        auto_reply_set: "✅ Otomatik yanıt mesajınız belirlendi. Artık size yazılan herhangi bir mesaja bu metin otomatik olarak gönderilecek.",
    ...
    en: {
        ...
        auto_reply_set: "✅ Auto-reply message set. This text will now be automatically sent to any message written to you.",
    ...
    ru: {
        ...
        auto_reply_set: "✅ Автоответ настроен. Этот текст теперь будет автоматически отправляться на любое сообщение, написанное вам.",
